        ...
        <Dialog
            ...
            PaperProps={{
                sx: {
                    ...
                    bgcolor: "#07080e",
                    width: isFullScreen ? "100vw" : 840,
                    height: isFullScreen ? "100vh" : 560,
                    minWidth: isFullScreen ? "100vw" : 480,
                ...
                >
                            ...
                            <Box sx={{ position: "relative" }}>
                                ...
                                <Box
                                    sx={{
                                        ...
                                        animation: "rippleOuter 3s cubic-bezier(0.2, 0.8, 0.2, 1) infinite",
                                ...
                                <Box
                                    sx={{
                                        ...
                                        animation: "rippleOuter 3s cubic-bezier(0.2, 0.8, 0.2, 1) infinite 1.5s",
                                    }}
                                />
                                <Avatar
                                    src={userData?.avatar}
                                    ...
                                    sx={{
                                        ...
                                        boxShadow: "0 24px 64px rgba(0, 0, 0, 0.7), 0 0 30px rgba(99, 102, 241, 0.15)",
                                        position: "relative",
                                        zIndex: 1,
                                    }}
                                />
                    ...
                    <Box
                        sx={{
                            ...
                            bottom: 16,
                            right: 16,
                            width: isFullScreen ? { xs: 160, sm: 220, md: 260 } : 180,
                            height: isFullScreen ? { xs: 120, sm: 165, md: 195 } : 135,
                            borderRadius: "16px",
                            overflow: "hidden",
